...
class FenetrePrincipale(tk.Tk):
    def __init__(self):
        ...
        btn_presence_caracteristiques = tk.Button(navbar, text="Présence et Caractéristiques", command=self.ouvrir_fenetre_Lieu_caratheristiques)
        btn_presence_caracteristiques.pack(side="left", expand=True, fill='both')

        btn_interventions = tk.Button(navbar, text="Interventions", command=self.ouvrir_Interventions)
    ...
    def setup_background_animation(self):
        ...
        #self.image_paths ./Creation_dun_logiciel_de_Registre_delevage/images/*.png = glob.glob("Creation_dun_logiciel_de_Registre_delevage\\images\\cheval_blanc.png")
...
# Concaténez le répertoire de travail avec le chemin relatif vers le dossier d'images
     chemin_dossier_images = os.path.join(repertoire_de_travail, "Creation_dun_logiciel_de_Registre_delevage/images")

# Affichez le chemin complet
     print("Chemin complet vers le dossier d'images :", chemin_dossier_images)
     try:
        ...
        print("Aucune image n'a été trouvée dans le répertoire spécifié.")
