...
class FenetrePrincipale(tk.Tk):
    ...
    def afficher_pdf(self):
        ...
        if filename:
            ...
            # Créer une nouvelle fenêtre pour afficher le contenu du PDF
            fenetre_pdf = tk.Toplevel(self)
            fenetre_pdf.title("Contenu du PDF")
            text_widget = tk.Text(fenetre_pdf, wrap=tk.WORD)
