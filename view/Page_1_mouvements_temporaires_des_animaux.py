...
class FenetrePrincipale(Frame):
    def __init__(self, fenetre, height, width, col_titles):
        ...
        btn_mouvement_temporaire = Button(self, text="Valider", command=self.valider_informations, width=15, height=1)
        btn_mouvement_temporaire.grid(row=self.numberLines + 5, columnspan=self.numberColumns, sticky='nsew')
        
        btn_voir_histoire = Button(self, text="Voir l'histoire de mes mouvements", command=self.view_animals, width=15, height=1)
        btn_voir_histoire.grid(row=self.numberLines + 6, columnspan=self.numberColumns, sticky='nsew')
        
        btn_retour_menu = Button(self, text="Retour au menu principal", command=self.return_main_menu, width=15, height=1)
        btn_retour_menu.grid(row=self.numberLines + 7, columnspan=self.numberColumns, sticky='nsew')
