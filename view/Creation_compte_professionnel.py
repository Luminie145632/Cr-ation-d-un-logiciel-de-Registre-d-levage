...
class FenetrePrincipale(tk.Tk):
    def __init__(self):
        ...
        self.create_label_entry("Saisisez votre mail :", "entry_mail", "Saisisez votre adresse e-mail", required=True)
    ...
    def soumettre_formulaire(self):
        ...
        if not siret or not code_ape or not adresse or not tel or not mail:
